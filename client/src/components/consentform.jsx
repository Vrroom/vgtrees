    ...
    <Container className="px-5">
      <Row>
        <Col>
          ...
          <h4>Procedures</h4>
          <p>The study is divided into two phases.</p>
          <p>
            In the first phase, you'll understand the goals of this study. You
            will complete a tutorial. The tutorial will walk you through our
            annotation interface and teach you how to produce annotations that
          ...
          <ol>
            <li>
              Whether you are an authentic participant. We will judge this using
              cookies, a captcha, your MTurk ID and your IP address.
            </li>
            <li>
              Whether you demonstrate an understanding of the goals of the
          ...
          <ol>
            ...
            <li>
              We'll send a copy of this form along with a survey to the email
